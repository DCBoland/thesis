...
\begin{figure}[btph]
  ...
  \caption[View-switching for VR typing study]{Typing Condition 4: VR/Reality switching. The user's view switched between reality and virtuality depending on which they were presently engaging with.}
