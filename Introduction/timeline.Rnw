...
Jan, 2015 & \textbf{BeoSound Moment} - Bang \& Olufsen device launched, adopting the engagement-dependent approach and concepts, described in \chapref{chap:industrial}.\endlr
